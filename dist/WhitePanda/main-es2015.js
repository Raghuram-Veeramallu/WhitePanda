...
let CascadingCardComponent = class CascadingCardComponent {
    constructor() {
        this.headerType = '';
        this.title = '';
...
let CascadingPanelComponent = class CascadingPanelComponent {
    constructor() {
        this.headerType = '';
        this.title = '';
        this.panelClass = '';
...
let OverlayCardComponent = class OverlayCardComponent {
    constructor() {
        this.alignment = 'center';
        this.src = '';
        this.color = '';
...
let CompStoreComponent = class CompStoreComponent {
    constructor() {
        this.cardcontent = [
            {
                title: 'Blog/Article',
